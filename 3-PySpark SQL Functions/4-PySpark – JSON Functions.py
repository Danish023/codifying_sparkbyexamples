...
# convert it to struct, mapt type e.t.c
...
# The below example converts JSON string to Map key-value pair.
...
df.select(col("id"), get_json_object(col("value"), "$.ZipCodeType")
          .alias("ZipCodeType")).show(truncate=False)
